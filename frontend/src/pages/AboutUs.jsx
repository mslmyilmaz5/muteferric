...
export const AboutUs = () => {
  return (
    <>
      <Helmet>
        <title>Hakkımızda | Şiirle | Şiir ve Yazı</title>
        <meta name="description" content="Anlamak muhakkak ki yüce bir şey. 
        İnsanı dolayısıyla başta da dediğimiz gibi şiiri külliyen anlamak belki mümkün değil fakat kısmen anlamak mümkün.
        Burada dolaşan, burada dolaşmayı tercih eden ve burada içinin rahatladığını hisseden herkesi sırf bu yüzden bile “kısmen” anlayabileceğimize
        inanıyoruz.Müteferriçler olarak şiir ve yazılarda rast gelmek dileğiyle.." />
