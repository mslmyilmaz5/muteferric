...
export const PoetrySingle = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{poem.title} | Şiirle</title>
                <meta name="description" content={`${p_user ? p_user.name : ''}'in "${poem.title}" adlı şiirini okuyun. 
                Şiirle platformunda, bu ve diğer şiirleri keşfedin.`} />
